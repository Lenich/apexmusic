...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/assets/style/reset.css"> <!-- css reset file -->
	<link rel="stylesheet" type="text/css" href="/assets/style/styles.css">	<!-- main snippets file -->
	<link rel="stylesheet" type="text/css" href="/assets/style/grid.css">	<!-- grids and coloumns file -->
