                ...
                <div class="promo-block">
                        ...
                        <!--<div class="review">
                                ...
                                <div class="description">
                                        <h5>Дима</h5>
                                        Софья Александровна - опытный профессионал, который обладает обширными знаниями и навыками игры на гитаре. Это требовательный и внимательный педагог, который находит равновесие между музыкальной теорией и практикой. При этом на занятиях царит непринуждённая атмосфера, присутствует взаимопонимание и юмор между учителем и учеником. Очень благодарен Софье Александровне за то, что она учитывала мои пожелания в выборе изучаемых произведений.
                                        <a href="#" class="more"><i>↓</i>Развернуть</a>
                                </div>
                        </div>

                        <div class="review">
                                <img src="round_photo_1.png">
                                <div class="description">
                                        <h5>Елизавета</h5>
